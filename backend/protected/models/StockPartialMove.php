...
/**
 * This is the model class for table "stock_partial_move".
 *
 * The followings are the available columns in table 'stock_partial_move':
 * @property integer $id
 ...
 */
class StockPartialMove extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			...
			'stockPartialMoveLines' => array(self::HAS_MANY, 'StockPartialMoveLine', 'wizard_id'),
		);
	}
	 ...
	 * @return StockPartialMove the static model class
	 */
