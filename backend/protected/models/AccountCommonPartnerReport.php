...
/**
 * This is the model class for table "account_common_partner_report".
 *
 * The followings are the available columns in table 'account_common_partner_report':
 * @property integer $id
 ...
 */
class AccountCommonPartnerReport extends CActiveRecord
{
	/**
	...
	{
		return 'account_common_partner_report';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, create_uid, create_date, write_date, write_uid, chart_account_id, period_to, date_from, result_selection, filter, period_from, fiscalyear_id, date_to, target_move', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'accountCommonPartnerReportAccountJournalRels' => array(self::HAS_MANY, 'AccountCommonPartnerReportAccountJournalRel', 'account_common_partner_report_id'),
	 ...
	 * @return AccountCommonPartnerReport the static model class
	 */
