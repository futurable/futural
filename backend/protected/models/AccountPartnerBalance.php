...
/**
 * This is the model class for table "account_partner_balance".
 *
 * The followings are the available columns in table 'account_partner_balance':
 * @property integer $id
 * @property integer $create_uid
 * @property string $create_date
 * @property string $write_date
 * @property integer $write_uid
 * @property string $display_partner
 ...
 */
class AccountPartnerBalance extends CActiveRecord
{
	/**
	...
	{
		return 'account_partner_balance';
	}
	...
	public function rules()
	{
		...
		return array(
			array('chart_account_id, result_selection, filter, target_move', 'required'),
			array('create_uid, write_uid, chart_account_id, period_to, period_from, fiscalyear_id', 'numerical', 'integerOnly'=>true),
			array('create_date, write_date, display_partner, date_from, date_to', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, create_uid, create_date, write_date, write_uid, display_partner, chart_account_id, period_to, date_from, result_selection, filter, period_from, fiscalyear_id, date_to, target_move', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'accountPartnerBalanceJournalRels' => array(self::HAS_MANY, 'AccountPartnerBalanceJournalRel', 'account_id'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'write_uid' => 'Write Uid',
			'display_partner' => 'Display Partner',
	...
	public function search()
	{
		...
		$criteria->compare('display_partner',$this->display_partner,true);
	 ...
	 * @return AccountPartnerBalance the static model class
	 */
