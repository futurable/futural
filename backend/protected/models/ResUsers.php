...
class ResUsers extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			...
			'purchaseOrdersWritten' => array(self::HAS_MANY, 'PurchaseOrder', 'write_uid'),
			'purchaseOrdersValidated' => array(self::HAS_MANY, 'PurchaseOrder', 'validator'),
			'purchaseOrdersCreated' => array(self::HAS_MANY, 'PurchaseOrder', 'create_uid'),
