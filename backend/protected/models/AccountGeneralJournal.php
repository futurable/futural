...
/**
 * This is the model class for table "account_general_journal".
 *
 * The followings are the available columns in table 'account_general_journal':
 * @property integer $id
 ...
 */
class AccountGeneralJournal extends CActiveRecord
{
	/**
	...
	{
		return 'account_general_journal';
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'accountGeneralJournalJournalRels' => array(self::HAS_MANY, 'AccountGeneralJournalJournalRel', 'account_id'),
		);
	}
	 ...
	 * @return AccountGeneralJournal the static model class
	 */
