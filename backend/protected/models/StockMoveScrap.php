...
/**
 * This is the model class for table "stock_move_scrap".
 *
 * The followings are the available columns in table 'stock_move_scrap':
 * @property integer $id
 ...
 */
class StockMoveScrap extends CActiveRecord
{
	/**
	 ...
	 * @return StockMoveScrap the static model class
	 */
