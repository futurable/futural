...
/**
 * This is the model class for table "calendar_todo".
 *
 * The followings are the available columns in table 'calendar_todo':
 * @property integer $id
 ...
 */
class CalendarTodo extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('date_deadline', 'required'),
			array('create_uid, write_uid, sequence, base_calendar_alarm_id, duration, month_list, user_id, day, count, interval, alarm_id, recurrent_id, organizer_id', 'numerical', 'integerOnly'=>true),
			...
			array('create_date, write_date, allday, we, tu, recurrency, week_list, state, show_as, th, exdate, fr, recurrent_id_date, description, end_date, byday, date, active, class, end_type, mo, su, sa, rrule_type, select1', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, create_uid, create_date, write_date, write_uid, allday, sequence, we, base_calendar_alarm_id, rrule, duration, organizer, month_list, user_id, vtimezone, tu, recurrency, week_list, day, state, base_calendar_url, show_as, location, th, exrule, exdate, fr, recurrent_id_date, description, end_date, byday, date, active, class, count, end_type, name, date_deadline, mo, interval, su, alarm_id, recurrent_id, organizer_id, sa, rrule_type, select1', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'calendarTodoResPartnerRels' => array(self::HAS_MANY, 'CalendarTodoResPartnerRel', 'calendar_todo_id'),
	 ...
	 * @return CalendarTodo the static model class
	 */
