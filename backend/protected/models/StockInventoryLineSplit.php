...
/**
 * This is the model class for table "stock_inventory_line_split".
 *
 * The followings are the available columns in table 'stock_inventory_line_split':
 * @property integer $id
 ...
 */
class StockInventoryLineSplit extends CActiveRecord
{
	/**
	...
	{
		return 'stock_inventory_line_split';
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'stockInventoryLineSplitLines' => array(self::HAS_MANY, 'StockInventoryLineSplitLines', 'wizard_id'),
			'stockInventoryLineSplitLines1' => array(self::HAS_MANY, 'StockInventoryLineSplitLines', 'wizard_exist_id'),
		);
	}
	 ...
	 * @return StockInventoryLineSplit the static model class
	 */
