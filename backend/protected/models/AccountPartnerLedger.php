...
/**
 * This is the model class for table "account_partner_ledger".
 *
 * The followings are the available columns in table 'account_partner_ledger':
 * @property integer $id
 ...
 */
class AccountPartnerLedger extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('create_date, write_date, initial_balance, date_from, page_split, date_to, amount_currency', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, create_uid, create_date, write_date, write_uid, initial_balance, chart_account_id, period_to, date_from, result_selection, filter, period_from, fiscalyear_id, page_split, date_to, amount_currency, target_move', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'accountPartnerLedgerJournalRels' => array(self::HAS_MANY, 'AccountPartnerLedgerJournalRel', 'account_id'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('page_split',$this->page_split);
	 ...
	 * @return AccountPartnerLedger the static model class
	 */
