...
class EmailTemplate extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			...
			'emailTemplateAttachmentRels' => array(self::HAS_MANY, 'EmailTemplateAttachmentRel', 'email_template_id'),
		);
	}
