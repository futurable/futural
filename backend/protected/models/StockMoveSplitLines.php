...
/**
 * This is the model class for table "stock_move_split_lines".
 *
 * The followings are the available columns in table 'stock_move_split_lines':
 * @property integer $id
 ...
 * @property StockMoveSplit $wizard
 * @property StockMoveSplit $wizardExist
 * @property StockProductionLot $prodlot
 * @property ResUsers $createU
 */
class StockMoveSplitLines extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			...
			'wizard' => array(self::BELONGS_TO, 'StockMoveSplit', 'wizard_id'),
			'wizardExist' => array(self::BELONGS_TO, 'StockMoveSplit', 'wizard_exist_id'),
	 ...
	 * @return StockMoveSplitLines the static model class
	 */
