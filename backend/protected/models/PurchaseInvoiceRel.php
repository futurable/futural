...
/**
 * This is the model class for table "purchase_invoice_rel".
 *
 * The followings are the available columns in table 'purchase_invoice_rel':
 ...
 */
class PurchaseInvoiceRel extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('purchase_id, invoice_id', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return PurchaseInvoiceRel the static model class
	 */
