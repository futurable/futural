...
/**
 * This is the model class for table "meeting_attendee_rel".
 *
 * The followings are the available columns in table 'meeting_attendee_rel':
 ...
 */
class MeetingAttendeeRel extends CActiveRecord
{
	/**
	 ...
	 * @return MeetingAttendeeRel the static model class
	 */
