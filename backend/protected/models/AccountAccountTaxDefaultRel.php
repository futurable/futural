...
/**
 * This is the model class for table "account_account_tax_default_rel".
 *
 * The followings are the available columns in table 'account_account_tax_default_rel':
 ...
 */
class AccountAccountTaxDefaultRel extends CActiveRecord
{
	/**
	...
	{
		return 'account_account_tax_default_rel';
	}
	 ...
	 * @return AccountAccountTaxDefaultRel the static model class
	 */
