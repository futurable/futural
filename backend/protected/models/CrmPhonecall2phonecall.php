...
/**
 * This is the model class for table "crm_phonecall2phonecall".
 *
 * The followings are the available columns in table 'crm_phonecall2phonecall':
 * @property integer $id
 ...
 */
class CrmPhonecall2phonecall extends CActiveRecord
{
	/**
	...
	{
		return 'crm_phonecall2phonecall';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, create_uid, create_date, write_date, write_uid, user_id, name, categ_id, section_id, note, phone, date, action, contact_name, partner_id', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return CrmPhonecall2phonecall the static model class
	 */
