...
/**
 * This is the model class for table "product_taxes_rel".
 *
 * The followings are the available columns in table 'product_taxes_rel':
 ...
 */
class ProductTaxesRel extends CActiveRecord
{
	/**
	 ...
	 * @return ProductTaxesRel the static model class
	 */
