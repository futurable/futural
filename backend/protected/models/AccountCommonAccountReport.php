...
/**
 * This is the model class for table "account_common_account_report".
 *
 * The followings are the available columns in table 'account_common_account_report':
 * @property integer $id
 ...
 */
class AccountCommonAccountReport extends CActiveRecord
{
	/**
	...
	{
		return 'account_common_account_report';
	}
	...
	public function rules()
	{
		...
		return array(
			array('chart_account_id, filter, display_account, target_move', 'required'),
			...
			array('id, create_uid, create_date, write_date, write_uid, chart_account_id, date_from, period_to, filter, period_from, fiscalyear_id, date_to, display_account, target_move', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'accountCommonAccountReportAccountJournalRels' => array(self::HAS_MANY, 'AccountCommonAccountReportAccountJournalRel', 'account_common_account_report_id'),
		);
	}
	 ...
	 * @return AccountCommonAccountReport the static model class
	 */
