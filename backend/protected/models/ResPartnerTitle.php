...
class ResPartnerTitle extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('name', 'length', 'max'=>46),
			array('shortcut', 'length', 'max'=>16),
			array('create_date, write_date', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, create_uid, create_date, write_date, write_uid, domain, name, shortcut', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'crmLeads' => array(self::HAS_MANY, 'CrmLead', 'title'),
