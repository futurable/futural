...
/**
 * This is the model class for table "stock_partial_move_line".
 *
 * The followings are the available columns in table 'stock_partial_move_line':
 * @property integer $id
 ...
 * @property StockPartialMove $wizard
 ...
 */
class StockPartialMoveLine extends CActiveRecord
{
	/**
	...
	{
		return 'stock_partial_move_line';
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'wizard' => array(self::BELONGS_TO, 'StockPartialMove', 'wizard_id'),
	 ...
	 * @return StockPartialMoveLine the static model class
	 */
