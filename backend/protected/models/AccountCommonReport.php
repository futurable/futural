 ...
 */
class AccountCommonReport extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, create_uid, create_date, write_date, write_uid, chart_account_id, date_from, period_to, filter, period_from, fiscalyear_id, date_to, target_move', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'accountCommonReportAccountJournalRels' => array(self::HAS_MANY, 'AccountCommonReportAccountJournalRel', 'account_common_report_id'),
	 ...
	 * @return AccountCommonReport the static model class
	 */
