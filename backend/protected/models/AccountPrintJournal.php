...
/**
 * This is the model class for table "account_print_journal".
 *
 * The followings are the available columns in table 'account_print_journal':
 * @property integer $id
 ...
 * @property string $sort_selection
 ...
 */
class AccountPrintJournal extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('chart_account_id, sort_selection, filter, target_move', 'required'),
			array('create_uid, write_uid, chart_account_id, period_to, period_from, fiscalyear_id', 'numerical', 'integerOnly'=>true),
			array('create_date, write_date, date_from, date_to, amount_currency', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, create_uid, create_date, write_date, write_uid, chart_account_id, sort_selection, date_from, period_to, filter, period_from, fiscalyear_id, date_to, amount_currency, target_move', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'accountPrintJournalJournalRels' => array(self::HAS_MANY, 'AccountPrintJournalJournalRel', 'account_id'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('sort_selection',$this->sort_selection,true);
	 ...
	 * @return AccountPrintJournal the static model class
	 */
