...
/**
 * This is the model class for table "account_central_journal".
 *
 * The followings are the available columns in table 'account_central_journal':
 * @property integer $id
 ...
 */
class AccountCentralJournal extends CActiveRecord
{
	/**
	...
	{
		return 'account_central_journal';
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'accountCentralJournalJournalRels' => array(self::HAS_MANY, 'AccountCentralJournalJournalRel', 'account_id'),
		);
	}
	 ...
	 * @return AccountCentralJournal the static model class
	 */
