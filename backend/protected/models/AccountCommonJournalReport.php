...
/**
 * This is the model class for table "account_common_journal_report".
 *
 * The followings are the available columns in table 'account_common_journal_report':
 * @property integer $id
 ...
 */
class AccountCommonJournalReport extends CActiveRecord
{
	/**
	...
	{
		return 'account_common_journal_report';
	}
	...
	public function rules()
	{
		...
		return array(
			array('chart_account_id, filter, target_move', 'required'),
			...
			array('id, create_uid, create_date, write_date, write_uid, chart_account_id, date_from, period_to, filter, period_from, fiscalyear_id, date_to, amount_currency, target_move', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'accountCommonJournalReportAccountJournalRels' => array(self::HAS_MANY, 'AccountCommonJournalReportAccountJournalRel', 'account_common_journal_report_id'),
	 ...
	 * @return AccountCommonJournalReport the static model class
	 */
