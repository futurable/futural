...
/**
 * This is the model class for table "account_balance_report".
 *
 * The followings are the available columns in table 'account_balance_report':
 * @property integer $id
 ...
 */
class AccountBalanceReport extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'accountBalanceReportJournalRels' => array(self::HAS_MANY, 'AccountBalanceReportJournalRel', 'account_id'),
	 ...
	 * @return AccountBalanceReport the static model class
	 */
