 ...
 *
 * The followings are the available columns in table 'account_chart':
 * @property integer $id
 ...
 * @property AccountFiscalyear $fiscalyear0
 * @property ResUsers $createU
 */
class AccountChart extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('target_move', 'required'),
			array('create_uid, write_uid, period_from, period_to, fiscalyear', 'numerical', 'integerOnly'=>true),
			array('create_date, write_date', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, create_uid, create_date, write_date, write_uid, period_from, period_to, target_move, fiscalyear', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'fiscalyear0' => array(self::BELONGS_TO, 'AccountFiscalyear', 'fiscalyear'),
	...
	public function search()
	{
		...
		$criteria->compare('fiscalyear',$this->fiscalyear);
	 ...
	 * @return AccountChart the static model class
	 */
